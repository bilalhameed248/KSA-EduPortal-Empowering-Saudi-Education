...
<div class="page-bar">
	<div class="page-title-breadcrumb">
		<div class=" pull-left">
			<div class="page-title">Edit Assign Teacher</div>
		</div>
...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			...
			<form method="POST" action="{{route('update_assigned_teacher')}}" enctype="multipart/form-data">
			@csrf
			<div class="card-body row">
				<div class="col-lg-6 p-t-20">
					<div
						class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
						<input class="mdl-textfield__input" type="text" id="listBranch" value="{{$specific_teacher_classroom->first_name.' '.$specific_teacher_classroom->last_name}}" readonly
							tabIndex="-1">
						<input type="hidden" name="teacher_classroom_id" value="{{$specific_teacher_classroom->teacher_classroom_id}}">
						<input type="hidden" name="already_teacher_id" value="{{$specific_teacher_classroom->teacher_id}}">
				...
				<div class="col-lg-6 p-t-20">
					<div
						class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
						<input class="mdl-textfield__input" type="text" id="listVP" value="{{$specific_teacher_classroom->classroom_name}}" readonly
							tabIndex="-1">
						<input type="hidden" name="already_classroom_id" value="{{$specific_teacher_classroom->classroom_id}}">
