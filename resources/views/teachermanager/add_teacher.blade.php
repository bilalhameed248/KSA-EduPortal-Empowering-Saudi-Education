...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			...
			<form method="POST" action="{{route('add_teacher')}}" enctype="multipart/form-data">
			@csrf
			<div class="card-body row">
				...
				<div class="col-lg-12 p-t-20 text-center">
					...
					<button type="button"
						class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-default" onclick="location.href='{{ url('allteachers') }}'">Cancel</button>
				</div>
			</div>
		</form>
		</div>
