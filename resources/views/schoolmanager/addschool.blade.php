...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			...
			<form method="POST" action="{{route('add_school')}}" enctype="multipart/form-data">
			@csrf
			<div class="card-body row">
				...
				<div class="col-lg-6 p-t-20">
					<div
						...
						<input required class="mdl-textfield__input" type="text" name="schoolname" id="schoolname">
				...
				<div class="col-lg-6 p-t-20">
					<div
						...
						<ul data-mdl-for="listVP" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
							...
							<li class="mdl-menu__item viceprinciple" value="{{$viceprinciple1->id}}">
								{{$viceprinciple1->first_name." ".$viceprinciple1->last_name}}
							</li>
							@endforeach
				...
				<div class="col-lg-6 p-t-20">
					<div
						class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
						<input class="mdl-textfield__input" type="text" id="listFor" value="" readonly
							tabIndex="-1">
