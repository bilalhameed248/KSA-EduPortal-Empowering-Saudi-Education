...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			...
			<form method="POST" action="{{route('get_report_t')}}" enctype="multipart/form-data">
			@csrf
				...
				<div class="col-lg-6 p-t-20">
					<div
						...
						<select required id="allclass" class="form-control">
							<option selected disbaled>Select Classroom</option>
							@foreach($allbranch as $allbranch1)
					        <option value="{{$allbranch1->classroom_id}}">{{$allbranch1->classroom_name}}</option>
					        @endforeach
					    </select>
